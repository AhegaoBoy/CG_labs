...
execute_process(
  COMMAND "/usr/bin/git" show-ref "bf71a834948186f4097caa076cd2663c69a10e1e"
  WORKING_DIRECTORY "/mnt/a/mai_stuff/Computer_grafics/game_engine/cmake-build-debug/_deps/glm-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/a/mai_stuff/Computer_grafics/game_engine/cmake-build-debug/_deps/glm-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/a/mai_stuff/Computer_grafics/game_engine/cmake-build-debug/_deps/glm-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
